    ...
    <div className="max-w-[1640] mx-auto p-4 py-12 grid md:grid-cols-3 gap-6">
      ...
      <div className="rounded-xl relative">
        ...
        <div className="absolute w-full h-full bg-black/50 rounded-xl text-white">
          <p className="font-bold text-2xl px-2 pt-4">
            Sun's Out, Bun's Out. BOGO
          </p>
          <p className="px-2">Through 1/20</p>
      ...
      <div className="rounded-xl relative">
        ...
        <div className="absolute w-full h-full bg-black/50 rounded-xl text-white">
          ...
          <p className="px-2">For That Sweet Tooth...</p>
          <button className="border-white bg-white text-black mx-2 absolute bottom-4">
            Order Now
          </button>
        </div>
        <img
          className="max-h-[160px] md:max-h-[200px] w-full object-cover rounded-xl"
          src="https://images.pexels.com/photos/2144112/pexels-photo-2144112.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
          alt="/"
        />
      </div>
    </div>
